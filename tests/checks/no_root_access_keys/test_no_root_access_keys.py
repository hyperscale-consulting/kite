"""Tests for the No Root Access Keys check."""
...
def mock_get_account_ids():
    ...
    with patch(
        "kite.checks.no_root_access_keys.check.get_account_ids_in_scope"
    ) as mock:
...
def mock_get_account_summary():
    ...
    with patch("kite.checks.no_root_access_keys.check.get_account_summary") as mock:
        yield mock
