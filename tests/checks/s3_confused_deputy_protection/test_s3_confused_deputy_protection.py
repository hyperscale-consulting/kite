...
@pytest.fixture
def bucket_with_confused_deputy_protection_upper_case(workload_account_id,
                                                      organization):
    bucket = {
        "Name": "test-bucket",
        "Policy": json.dumps({
...
def test_s3_no_confused_deputy_protection(bucket_with_no_confused_deputy_protection,
                                          no_org_config):
    result = check_s3_confused_deputy_protection()
...
def test_s3_confused_deputy_protection_upper_case_arn_like(
        bucket_with_confused_deputy_protection_upper_case_arn_like,
        no_org_config
):
    result = check_s3_confused_deputy_protection()
    assert result["status"] == "PASS"
