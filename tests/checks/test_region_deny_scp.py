...
def test_check_region_deny_scp_pass_root():
    ...
    with (
        patch("kite.checks.region_deny_scp.get_organization", return_value=mock_org),
        patch(
            "kite.checks.region_deny_scp.Config.get",
...
def test_check_region_deny_scp_no_org():
    ...
    with patch("kite.checks.region_deny_scp.get_organization", return_value=None):
        result = check_region_deny_scp()
...
def test_check_region_deny_scp_error():
    ...
    with patch(
        "kite.checks.region_deny_scp.get_organization",
